...
- **Mini-cotizadores de servicios (11/08/2026):** Al seleccionar Visualización (D5), Modelado BIM LOD 300 o Planos Ejecutivos en Servicios se muestra un cotizador interactivo con correo/WhatsApp a `habitarq85@gmail.com` vía Brevo:
  - **D5 (Perspectivas):** Interior $2,500 · Exterior $3,000 · Aéreo $4,500 por render. Complejidad ×0.8 (Básico) / ×1.0 (Medio) / ×2.5 (Cargado). Paquete 3-5 renders −10%, 6+ renders −15%. Tiempo referencia: 3-5 días/render, 1-3 semanas paquetes. Endpoint `POST /cotizar_perspectivas`. **Se renombró "COTIZADOR D5" → "COTIZADOR DE RENDERS" y se eliminó la opción "Integrado" (×1.65)**.
