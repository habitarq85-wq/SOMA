...
## 2. Paquetes de Diseno (Escala Oficial SOMA v2.1)
...
| **SOMA Integral** | $400/m2 | Esencial + moodboard de acabados, criterio de ingenierias, planos de permiso, perspectivas adicionales. |
| **SOMA Ejecutivo** | $1,000/m2 | Integral + planos tecnicos ejecutivos, detalles constructivos, coordinacion integral de ingenierias. |
...
- **$8,000 MXN** — se aplica silenciosamente para proteger la viabilidad de
